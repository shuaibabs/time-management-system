...
const resProviderRouter = require('./middleware/response-provider')
...
try {
  ...
  // //** Integrating Response to all Routes in Application
  // logger.log('** Integrating Response to all Routes in Application');
  // app.use(resProviderRouter.router);
